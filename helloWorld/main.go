...
func main() {
  ...
  fmt.Println("Now lets' talk about seasons")
  ...
  fmt.Println("Q1 is: ", Q1)
  fmt.Println("Q2 is: ", Q2)
  fmt.Println("Q3 is: ", Q3)
  fmt.Println("Q4 is: ", Q4)
  
  fmt.Println("North Winter is: ", winter)
  fmt.Println("North Spring: ", spring)
  fmt.Println("North Summer: ", summer)
  fmt.Println("North Autumn: ", autumn)
